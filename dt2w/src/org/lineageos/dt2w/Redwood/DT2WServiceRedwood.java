package org.lineageos.dt2w.Redwood;
...
public class DT2WServiceRedwood extends Service {
    private static final String TAG = "DT2WServiceRedwood";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.redwood.dt2w", dt2wEnabled ? "1" : "0");
        }
